...
var Client = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Client(options) {
    var _options$maxConnectTi, _options$delay;
    ...
    var MAX_CONNECT_TIMES = (_options$maxConnectTi = options.maxConnectTimes) !== null && _options$maxConnectTi !== void 0 ? _options$maxConnectTi : 10; // 最多重试次数

    var DELAY = (_options$delay = options.delay) !== null && _options$delay !== void 0 ? _options$delay : 15000; // 重试间隔

    _this.options = _objectSpread2({
      enableLog: true
    }, options);
    _this.textDecoder = new util.TextDecoder('utf-8');
    _this.textEncoder = new util.TextEncoder();
          ...
          case 5:
            ...
            for (var offset = 0, _packetLen, _body; offset < data.byteLength; offset += _packetLen) {
              ...
              try {
                ...
                _this2.messageReceived(_ver, op, JSON.parse(_body), ts);
